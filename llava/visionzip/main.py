...
from .llava_arch import prepare_inputs_labels_for_multimodal_visionzip_visiondrop, encode_images_visionzip, encode_images_visionzip_multi, restore_image_features_sorted

def visionzip(model, dominant=191, contextual=30):

    print("===> visionzip() called")
    ...
    if hasattr(LlavaMetaForCausalLM, 'prepare_inputs_labels_for_multimodal'):
        LlavaMetaForCausalLM.prepare_inputs_labels_for_multimodal_visiondrop = prepare_inputs_labels_for_multimodal_visionzip_visiondrop
